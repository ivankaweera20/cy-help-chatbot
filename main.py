#My console is not working properly so I reached out to Replit support and they couldn't figure out how to fix it either, but this input() makes everything normal again 
#You will have to click on the console area and press enter to get the program started
